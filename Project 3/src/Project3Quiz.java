...
public class Project3Quiz {
	...
	public static void main(String[] args) {
		...
		System.out.println("Question 1: Do you prefer to be outdoors or indoors?");
		String answer1;
		do {
			System.out.println("Enter outdoors or indoors:");
			answer1=console.next();
		} while (!answer1.equalsIgnoreCase("outdoors")
				&& !answer1.equalsIgnoreCase("indoors"));
		...
		} while (!answer2.equalsIgnoreCase("A") 
				&& !answer2.equalsIgnoreCase("B")
				&& !answer2.equalsIgnoreCase("C")
				&& !answer2.equalsIgnoreCase("D")); 
		...
		} while (!answer3.equalsIgnoreCase("A") 
				&& !answer3.equalsIgnoreCase("B")
				&& !answer3.equalsIgnoreCase("C")
		...
		} while (!answer4.equalsIgnoreCase("A") 
				&& !answer4.equalsIgnoreCase("B")
				&& !answer4.equalsIgnoreCase("C")
